                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control article-title" id="title" name="title"
                                    required placeholder="Enter Article Title" value="{{ $article->title }}">
                                <div class="mt-1 text-primary" style="cursor:not-allowed">

                                    <small class="site-url">
                                        {{ url('/news/') }}</small>/<small class="article-slug">{{ $article->slug }}</small>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="btn-group pb-2 pb-lg-0 w-100" role="group" aria-label="Basic example">
                                <button type="submit" class="btn btn-primary w-100 fw-bolder" id="submit-article">Update
                                    Post</button>
                                <button type="button"
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="article-content" name="content" rows="5" required
                            placeholder="Start writing the post content">{{ $article->content }}</textarea>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" id="type" name="type">
                                    <option value="text" {{ $article->type == 'text' ? 'selected' : '' }}>Text</option>
                                    <option value="video" {{ $article->type == 'video' ? 'selected' : '' }} disabled>Video
                                    </option>
                                </select>
                            </div>
                                ...
                                <select class="form-control form-control-sm" id="classification_id"
                                    ...
                                    @foreach ($classifications as $classification)
                                        <option value="{{ $classification->id }}"
                                            {{ $article->classification_id == $classification->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div id="imagePreviewContainer" style="margin-top: 10px;">
                                    <img id="imagePreview" src="{{ asset($article->image) }}" alt="Image Preview"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" id="allow_comments" name="allow_comments">
                                    <option value="yes" {{ $article->allow_comments ? 'selected' : '' }}>Yes</option>
                                    <option value="no" {{ $article->allow_comments ? '' : 'selected' }}>No</option>
