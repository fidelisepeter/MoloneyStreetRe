...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Youtube Playlist</h4>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    <div style="font-weight: 600; line-height: 1;">
                                                        ...
                                                        {{ (new \App\Helpers\SiteHelper())->truncateText($item->title, 70) }}
                                                    </div>
                                                    <div
                                                        class="mt-2 d-flex align-items-center gap-1 font-weight-light small-text small mb-0 text-muted">

                                                        {{ (new \App\Helpers\SiteHelper())->truncateText($item->description, 70) }}
                                        ...
                                        <td>
                                            <div class="mt-2 d-flex align-items-center gap-1">
                                                <a class="badge badge-primary" style="text-decoration: none"
                                                    href="{{ route('youtube.playlist.view', $item->id) }}" target="_blank">
                                                    Preview
                                                </a>
                                                <a class="badge badge-success" style="text-decoration: none"
                                                    href="{{ 'https://youtu.be/' . $item->id }}" target="_blank">
                                                    View on Youtube
                                                </a>
                                            </div>
                                        </td>
