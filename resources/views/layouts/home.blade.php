        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid p-0 mb-3">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
                    <a href="" class="navbar-brand d-block d-lg-none">
                        <h1 class="m-0 display-5 text-primary">{{ setting()->get('site_name', 'MoloneyStreetRe') }}
                        </h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            @foreach (\App\Models\Classification::whereHas('posts')->latest()->take(5)->get() as $classification)
                                <a href="{{ route('show', $classification) }}"
                                    class="nav-item nav-link @if (request()->routeIs('show', $classification)) active @endif">{{ $classification->title }}</a>
                            @endforeach

                            {{-- <a href="{{ route('show', 'latest-news') }}" class="nav-item nav-link">Latest</a> --}}
            ...
            <div class="sticky-icon">
                <a href="{{ setting()->get('instagram_url') }}"
                    style="--sticky-background: #fd1d1d; --sticky-background: linear-gradient(57deg, #833ab4, #fd1d1d 75%, #fcb045 100%);">Instagram<i
                        class="fab fa-instagram"></i> </a>
                <a href="{{ setting()->get('facebook_url') }}"
                    style="--sticky-background: #3b5998;--sticky-icon-color: #3b5998;">Facebook<i
                        class="fab fa-facebook-f">
                    </i>
                </a>
                <a href="{{ setting()->get('facebook_url') }}"
                    style="--sticky-background: #06a32d;--sticky-icon-color: #03b830;">WhatsApp<i
                        class="fab fa-whatsapp">
                    </i> </a>
                <a href="{{ setting()->get('youtube_url') }}"
                    style="--sticky-background: #fa0910;--sticky-icon-color: #fa0910;">Youtube<i
                        class="fab fa-youtube"></i>
                </a>
                <a href="{{ setting()->get('twitter_url') }}"
                    style="--sticky-background: #53c5ff;--sticky-icon-color: #53c5ff;">Twitter<i
            ...
            <div class="container-fluid bg-light pt-3 px-sm-3 px-md-5">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p class="mb-0">
                            {{ setting()->get('site_address', '1234 Demo Stree, City, State, 56789') }}
